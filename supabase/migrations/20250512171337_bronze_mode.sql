/*
  # Add Activity Tracking and AI Feedback

  1. New Tables
    - `daily_nutrition_logs`
      - Tracks actual daily nutrition values
      - Links to daily_activities and fitness_programs
      - Stores AI feedback and recommendations
  
  2. Changes
    - Add foreign key to link daily_activities with fitness_programs
...
-- Add foreign key to daily_activities
ALTER TABLE daily_activities
ADD COLUMN fitness_program_id INTEGER REFERENCES fitness_programs(id) ON DELETE SET NULL;
